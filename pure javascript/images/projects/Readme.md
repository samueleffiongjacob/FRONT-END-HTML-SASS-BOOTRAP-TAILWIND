<div align="center">
  <h1> Days Of JavaScript: Data Types</h1>
</div>

## Data Types 

In this section, we will talk about data types. Data or values have data types. Data types describe the characteristics of data. Data types can be divided into two:
...
```sh
Samuel  Jacob. I am 250. I live in Nigeria
```
...
Now, we are in 2020. I am enjoying preparing the DaysOfJavaScript challenge and \
...
console.log(firstName.toUpperCase())  // Samuel 
...
console.log(firstName.toLowerCase())  // Samuel 
...
console.log(firstName.split())    // Change to an array - > ["Samuel "]
...
```js
let string = '30'
console.log(string.concat("Days", "Of", "JavaScript")) // DaysOfJavaScript
...
console.log(country.startsWith('nig'))   // false
...
```js
alert('Welcome to DaysOfJavaScript')
```
...
1. Compare your first name length and your family name length and you should get this output.
    ...
    ```sh
    Your first name, Samuel  is longer than your family name, Jacob
    ```
...
let txt =
  'I love Software Enginner  and empowering people. I teach HTML, CSS, JS, React, Python.'
...
const names = ['Samuel ', 'Mathias', 'Elias', 'Brook']
console.log(names.toString()) // Samuel ,Mathias,Elias,Brook
```
...
console.log(names.join()) // Samuel ,Mathias,Elias,Brook
console.log(names.join('')) //Samuel MathiasEliasBrook
console.log(names.join(' ')) //Samuel  Mathias Elias Brook
console.log(names.join(', ')) //Samuel , Mathias, Elias, Brook
console.log(names.join(' # ')) //Samuel  # Mathias # Elias # Brook
...
1.Slice the first ten countries from the [countries array](https://github.com/samueleffiongjacob/PURE-JAVASCRIPT/tree/master/data/countries.js)
1. Find the middle country(ies) in the [countries array](https://github.com/samueleffiongjacob/PURE-JAVASCRIPT/tree/master/data/countries.js)
...
1. Extract all the countries contain the word 'land' from the [countries array](https://github.com/https://github.com/samueleffiongjacob/PURE-JAVASCRIPT/tree/master/data/countries.js) and print it as array
1. Find the country containing the hightest number of characters in the [countries array](https://github.com/https://github.com/samueleffiongjacob/PURE-JAVASCRIPT/tree/master/data/countries.js)
1. Extract all the countries contain the word 'land' from the [countries array](https://github.com/https://github.com/samueleffiongjacob/PURE-JAVASCRIPT/tree/master/data/countries.js) and print it as array
1. Extract all the countries containing only four characters from the [countries array](https://github.com/https://github.com/samueleffiongjacob/PURE-JAVASCRIPT/tree/master/data/countries.js) and print it as array
1. Extract all the countries containing two or more words from the [countries array](https://github.com/https://github.com/samueleffiongjacob/PURE-JAVASCRIPT/tree/master/data/countries.js) and print it as array
1. Reverse the [countries array](https://github.com/https://github.com/samueleffiongjacob/PURE-JAVASCRIPT/tree/master/data/countries.js) and capitalize each country and stored it as an array
=============================================================================================
## Functions
...
console.log(printFullName('Samuel ', 'Jacob'))
```
...
console.log(greetings('Samuel '))
```

```js
function generateFullName(firstName = 'Samuel ', lastName = 'Jacob') {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
...
```js
const generateFullName = (firstName = 'Samuel ', lastName = 'Jacob') => {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
...
```sh
Samuel  Jacob is a Software Engineer.
He lives in Nigeria.
...
```sh
[{name: 'Samuel ', score: 95}, { name: 'Lidiya', score: 98 },{name: 'Martha', score: 85},{name: 'John', score: 100}]
```
...
18. Use **_reduce_** to concatenate all the countries and to produce this sentence: **_Estonia, Nigeria, Sweden, Denmark, Norway, and IceLand are north European countries_**
...
1. Find out which _letter_ is used many _times_ as initial for a country name from the countries array (eg. Nigeria, Fiji, France etc)
...
console.log(getPersonInfo(person))
/*
Samuel  Jacob lives in Nigeria. He is  250 years old. He is an Instructor and Developer. He teaches HTML, CSS, JavaScript, React, Redux, Node, MongoDB, Python and D3.js. He speaks Amharic, English and a little bit of Suomi(Finnish)
*/
```
...
```sh
I am Software Engineer and  I love Software Enginner .There is nothing as more rewarding as educating and empowering people.I found Software Enginner  more interesting than any other jobs.Does this motivate you to be a Software Engineer.
```
...
![Regular Expression cheat sheet](/pure%20javascript/images/regex.png)
...
1. Write a function called *tenMostFrequentWords* which get the ten most frequent word from a string?
    ...
    ```js
        paragraph = `I love Software Enginner . If you do not love Software Enginner  what else can you love. I love Python if you do not love something which can give you all the capabilities to develop an application what else can you love.`
    ...
    ```sh
        ...
        {word:'can', count:3},
        {word:'what', count:2},
        {word:'Software Enginner ', count:2},
        {word:'not', count:2},
        {word:'else', count:2},
        {word:'do', count:2},
        {word:'I', count:2},
...
1. Writ a function which cleans text. Clean the following text. After cleaning, count three most frequent words in the string.
  ...
  ```js
   ...
   ```sh
    I am a Software Engineer and I love Software Enginner  There is nothing as more rewarding as educating and empowering people I found Software Enginner  more interesting than any other jobs Does this motivate you to be a Software Engineer
    ```
2. Write a function which find the most frequent words. After cleaning, count three most frequent words in the string.

  ```js
    console.log(mostFrequentWords(cleanedText))
    [{word:'I', count:3}, {word:'Software Enginner ', count:2}, {word:'Software Engineer', count:2}]
  ```
=========================================================================================================
...
const person1 = new Person('Samuel ', 'Jacob')

console.log(person1)
```

```sh
Person {firstName: "Samuel ", lastName: "Jacob"}
```
...
const person3 = new Person('Abraham', 'Jacob')
...
Person {firstName: "Abraham", lastName: "Jacob"}
```
...
```js
localStorage.setItem('firstName', 'Samuel ') // since the value is string we do not stringify it
console.log(localStorage)
```

```sh
Storage {firstName: 'Samuel ', length: 1}
```
...
```sh
 Storage {age: '200', firstName: 'Samuel ', length: 2}
```
...
```sh
Storage {age: '200', firstName: 'Samuel ', skills: 'HTML,CSS,JS,React', length: 3}
```
...
#### Conventions use in DaysOfJavaScript
...
<html lang="en">
  ...
  <body>
    <div class="wrapper">
        <h1>Samuel  Jacob challenges in 2020</h1>
...
<body>
    ...
    <h2>Samuel  Jacob challenges in 2020</h1>
    <ul>
        <li>DaysOfPython Challenge Done</li>
...
===================================================================================================================
Days Of JAVASCRIPT: MINI PROJECT SOLAR SYSTEM
...
===================================================================================================================
Days Of JAVASCRIPT: WORLD CONTRY DATA VISUALIZATION
## Exercises
...
2. Create the following using HTML, CSS, and JavaScript

3. Create the following using HTML, CSS, and JavaScript

![Slider](/pure%20javascript//images/projects/dom_mini_project_leaderboard_day_8.1.gif)

4. Create the following animation using (HTML, CSS, JS)

5. Create the following animation using (HTML, CSS, JS)

![Countries data](/pure%20javascript//images/projects/dom_mini_project_countries_object_day_10.1.gif)

6. Validate the following form using regex.
